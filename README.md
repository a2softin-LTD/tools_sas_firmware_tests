...
6. Run the command in the console: ```npx playwright test --grep "@sas_reactions_async_single_user_single_device_json" --workers={WORKER_NUMBER}```


- Example:
```
npx playwright test --grep "@sas_reactions_async_single_user_single_device_json" --workers=3
```
- #### Important! Use following tags: `@sas_reactions_async_single_user_single_device_json`
- #### Important! Use the number of `workers` equal to the `number of generated test files`
